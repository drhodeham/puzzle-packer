package com.drhodehamel.packer.screens;
...
import com.drhodehamel.packer.scenes.Hud;

/**
 * Created by Derek on 9/15/2017.
 */
...
public class PlayScreen implements Screen {
    ...
    public PlayScreen(Main game) {
        ...
        this.window = new FitViewport( Main.V_WIDTH, Main.V_HEIGHT, this.camera);
        this.hud = new Hud(game.batch);

        maploader = new TmxMapLoader();
        map = maploader.load("level1.tmx");
        renderer = new OrthogonalTiledMapRenderer(map);
        camera.position.set(window.getWorldWidth() / 2, window.getWorldHeight() / 2, 0);
    ...
    public void resize(int width, int height) {
        this.window.update(width, height);
    }
